...
variable "keyName" {
  default = "mykey_test_error"
}
variable "privatekeyPath" {
  default = "/home/ec2-user/terraform/keys/mykey_test_error.pem"
  #  ssh-keygen -f  mykey_test_error
  #  mv mykey_test_error mykey_test_error.pem
}
variable "publickeyName" {
  default = "mykey_test_error.pub"
}
# variable "publickeyPath" {
#   #  default = "/home/ec2-user/terraform/keys/mykey_test_error.pub"
