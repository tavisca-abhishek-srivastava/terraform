...
resource "aws_rds_cluster" "postgresql" {
  ...
  kms_key_id = module.rds_encryption_at_rest_cmk.mrk_cms_arn[0]
  storage_encrypted = true
...
resource "aws_rds_cluster_instance" "cluster_instances" {
  ...
  performance_insights_kms_key_id = module.rds_encryption_at_rest_cmk.mrk_cms_arn[0] #"arn:aws:kms:us-east-1:346319152574:key/mrk-4eca0415b8b4434f96399c2f2d80b1ef"
